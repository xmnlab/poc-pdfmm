...
Report bugs at https://github.com/xmnlab/poc-pdfmm/issues.
...
poc-pdfmm could always use more documentation,
whether as part of the official poc-pdfmm docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/xmnlab/poc-pdfmm/issues.
...
Ready to contribute? Here’s how to set up `poc-pdfmm` for local development.

1.  Clone your fork locally:
```bash
$ git clone git@github.com:xmnlab/poc-pdfmm.git
```

2.  Prepare your local development environment:
```bash
$ cd pdf-deweponizer-cpp
$ mamba env create --file conda/dev.yaml
$ conda activate poc-pdfmm
$ pre-commit install
```
...
4.  When you’re done making changes, check the compilation and the tests:
